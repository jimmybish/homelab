...
- **bubble-card** — Stylish cards with heavy customisation and pop-up functionality
...
- **Playwright MCP** (`microsoft/playwright-mcp`) — Take screenshots, interact with pages
- **Puppeteer MCP** — Similar browser automation capabilities
- **Chrome DevTools MCP** — Inspect elements, debug layouts
